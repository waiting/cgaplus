    ...
    while (true) {
        ...
        if (ff.curMapIs('芙蕾雅')) {
            if (ff.curInPtRange( placeCoord, 10 )) { // 练级地附近
                ...
                case ff.ActGoBattle:
                    try {
                        ...
                        let cnt = 0;
                        while (await ff.encounterEnemy(dir, 300, endcond, '芙蕾雅')) {
                            cnt++;
                            ...
                            console.log('恢复走到战斗点');
                            await ff.walk(placeCoord[0], placeCoord[1]);
                        }
            ...
            case ff.ActGoRecovery:
                ...
                await ff.turnDirOpenDialog(6); // 打开补血对话框
